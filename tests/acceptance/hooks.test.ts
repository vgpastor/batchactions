...
import type { RawRecord, ParsedRecord, ProcessedRecord } from '../../src/domain/model/Record.js';
import type { ImportHooks, HookContext } from '../../src/domain/ports/ImportHooks.js';
...
describe('Hooks', () => {
  ...
  it('should call afterProcess hook after successful processing', async () => {
    ...
    const firstCall = afterProcessSpy.mock.calls[0];
